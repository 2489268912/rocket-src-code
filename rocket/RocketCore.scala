...
//adding module
import freechips.rocketchip.snapshoot._
...
when(ctrl_killd && q_copyvalid && !ex_reg_valid && mem_reg_valid){
   intpc_reg := mem_npc
}
...
en_copyvalid := !sbo(32) && !fp_sbo(32) && !io.fpu.fpu_inflight && div.io.req.ready && statesignal && !isa.io.copy_done && !csr.io.interrupt && ctrl_killd && q_copyvalid && !fsign
